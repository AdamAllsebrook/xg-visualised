...
<a href='/' class='p-4 font-medium text-md underline text-white-800'>Return to home page</a>
<div
...
>
    <div class='pl-4 lg:pl-16'>
        ...
        <h2 class="text-lg lg:text-xl font-medium text-white-800">Expected goals, visualised.</h2>
    </div>
